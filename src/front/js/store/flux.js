    ...
    actions: {
      ...
      getProfileById: async (user_id) => {
        try {
          const resp = await fetch(
            process.env.BACKEND_URL + `/api/perfil/${user_id}`
          );
      ...
      guardarcategoria: async (categoria) => {
        try {
          ...
          const resp = await fetch(
            process.env.BACKEND_URL + "/api/categories/seleccionar",
            {
              method: "POST",
      ...
      enviarpeticion: async (peticionEnviada) => {
        try {
          ...
          const resp = await fetch(
            process.env.BACKEND_URL + "api/talentrequest",
            {
              method: "POST",
              body: JSON.stringify(bodyfetch),
              headers: {
