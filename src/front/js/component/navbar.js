      ...
      <nav id="navbar-bg-home" className="navbar navbar">
        ...
        <Link to="/" id="navlink">
          <div id="titulo-boton-navbar" className="">
            <span className="fs-4 text-white">Home</span>
          </div>
        </Link>
        <Link to="/categories" id="navlink">
          {store.token != null ? (
            <div id="titulo-boton-navbar" className="">
              <span className="fs-4 text-white">Categories</span>
            </div>
          ) : (
            ""
          )}
        ...
        <Link to="/aboutus" id="navlink">
          <div id="titulo-boton-navbar" className="">
            <span className="fs-4 text-white">About us</span>
          </div>
        </Link>
          ...
          <span className="fs-4 text-white">
            <div className="d-flex justify-content-end">
              <i
                ...
                href="https://github.com/4GeeksAcademy/buscatalento"
              ></i>
            </div>
          </span>
        </div>
        <div className="d-flex justify-content-end">
          <div className="m-3 p-1">
            {store.token != null ? (
              <Link to={`/perfil/` + store.user?.user_id}>
                <button
                  className="btn btn-outline-light"
                  id="buttons-navbar-home"
                >
                  Mi Perfil
                </button>
              </Link>
