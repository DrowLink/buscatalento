          ...
          <div className="d-flex flex-column">
            ...
            <img
              ...
              className={`rounded-circle ${
                isImageSelected(1) ? "selected img-thumbnail" : "img-thumbnail"
              }`}
              alt="..."
              onClick={() => {
                toggleSelection(1);
        ...
        <div className="col-md-4 d-flex justify-content-center">
          <div className="d-flex flex-column">
            ...
            <img
              ...
              id="categories"
              className={`rounded-circle ${
                isImageSelected(2) ? "selected img-thumbnail" : "img-thumbnail"
              }`}
              alt="..."
              onClick={() => {
                toggleSelection(2);
        ...
        <div className="col-md-4 d-flex justify-content-center">
          <div className="d-flex flex-column">
            ...
            <img
              ...
              id="categories"
              className={`rounded-circle ${
                isImageSelected(3) ? "selected img-thumbnail" : "img-thumbnail"
              }`}
              alt="..."
              onClick={() => {
                toggleSelection(3);
        ...
        <div className="col-md-4 d-flex justify-content-center">
          <div className="d-flex flex-column">
            ...
            <img
              ...
              id="categories"
              className={`rounded-circle ${
                isImageSelected(4) ? "selected img-thumbnail" : "img-thumbnail"
              }`}
              alt="..."
              onClick={() => {
                toggleSelection(4);
        ...
        <div className="col-md-4 d-flex justify-content-center">
          <div className="d-flex flex-column">
            ...
            <img
              ...
              id="categories"
              className={`rounded-circle ${
                isImageSelected(5) ? "selected img-thumbnail" : "img-thumbnail"
              }`}
              alt="..."
              onClick={() => {
                toggleSelection(5);
        ...
        <div className="col-md-4 d-flex justify-content-center">
          <div className="d-flex flex-column">
            ...
            <img
              ...
              id="categories"
              className={`rounded-circle ${
                isImageSelected(6) ? "selected img-thumbnail" : "img-thumbnail"
              }`}
              alt="..."
              onClick={() => {
                toggleSelection(6);
        ...
        <div className="col-md-4 d-flex justify-content-center">
          <div className="d-flex flex-column">
            ...
            <img
              ...
              id="categories"
              className={`rounded-circle ${
                isImageSelected(7) ? "selected img-thumbnail" : "img-thumbnail"
              }`}
              alt="..."
              onClick={() => {
                toggleSelection(7);
        ...
        <div className="col-md-4 d-flex justify-content-center">
          <div className="d-flex flex-column">
            ...
            <img
              ...
              id="categories"
              className={`rounded-circle ${
                isImageSelected(8) ? "selected img-thumbnail" : "img-thumbnail"
              }`}
              alt="..."
              onClick={() => {
                toggleSelection(8);
        ...
        <div className="col-md-4 d-flex justify-content-center">
          <div className="d-flex flex-column">
            ...
            <img
              ...
              id="categories"
              className={`rounded-circle ${
                isImageSelected(9) ? "selected img-thumbnail" : "img-thumbnail"
              }`}
              alt="..."
              onClick={() => {
                toggleSelection(9);
        ...
        <div className="col-md-4 d-flex justify-content-center">
          <div className="d-flex flex-column">
            ...
            <img
              ...
              id="categories"
              className={`rounded-circle ${
                isImageSelected(10) ? "selected img-thumbnail" : "img-thumbnail"
              }`}
              alt="..."
              onClick={() => {
                toggleSelection(10);
        ...
        <div className="col-md-4 d-flex justify-content-center">
          <div className="d-flex flex-column">
            ...
            <img
              ...
              id="categories"
              className={`rounded-circle ${
                isImageSelected(11) ? "selected img-thumbnail" : "img-thumbnail"
              }`}
              alt="..."
              onClick={() => {
                toggleSelection(11);
        ...
        <div className="col-md-4 d-flex justify-content-center">
          <div className="d-flex flex-column">
            ...
            <img
              ...
              id="categories"
              className={`rounded-circle ${
                isImageSelected(12) ? "selected img-thumbnail" : "img-thumbnail"
              }`}
              alt="..."
              onClick={() => {
                toggleSelection(12);
