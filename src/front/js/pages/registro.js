	...
	return ( <>
		<div id="container-registro" className="">
            ...
            <div id="input-box-1" className="row">
                <div id="input-section-1" className="col-4 d-flex justify-content-center">
                    <div id="circle-profile-img"></div>
                    {/* <h2>Profile Picture</h2> */}
                </div>
                <div id="input-section-2" className="col">
                    <p>Name</p>
                    <input id="name-field" type="text" className="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1"/>
                    <p>Phone</p>
                    <input id="phone-field" type="text" className="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1"/>
                    <p>City</p>
                    <select className="form-select" id="select-input" aria-label="Default select example">
                ...
                <div id="input-section-3" className="col">
                    <p>Lastname</p>
                    <input id="lastname-field" type="text" className="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1"/>
                    <p>Age</p>
                    <input id="phone-field"type="text" className="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1"/>
                    <p>Country</p>
                    <select className="form-select" id="select-input" aria-label="Default select example">
            ...
            <div id="input-box-2" className="row">
                ...
                <div id="input2-box-1" className="col-4 d-flex justify-content-center">
                    <div id="img-talent"></div>
                </div>
                <div id="input2-box-2" className="col">
                    <p>Cual es tu talento?</p>
                    <select className="form-select mb-3" id="select-input" aria-label="Default select example">
        ...
        <div id="end-section-modal" className="text-center">
            ...
            <button id="confirmation-button-registro" type="button" className="btn btn-success">Si</button>
            <button type="denial-button-registro" className="btn btn-danger">No</button>
            {/* <div class="progress">
