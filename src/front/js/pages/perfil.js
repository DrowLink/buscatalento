  ...
  return (
    <div className="container">
      <div id="profile-box-perfil" className="">
        ...
        <div id="section-1-card-perfil" className="row">
          <div id="description-profile-box-perfil" className="col">
            <input
              ...
              value={
                (store.perfil &&
                  store.perfil.perfil.name +
                    " " +
                    store.perfil.perfil.last_name) ||
                ""
              }
            />
            <input
              id="inputperfil-2"
              type="text"
              value={(store.perfil && store.perfil.perfil.age + " años") || " "}
            />
            <input
              id="inputperfil-2"
              type="text"
              value={
                (store.perfil &&
                  store.perfil.perfil.state +
                    ", " +
                    store.perfil.perfil.country) ||
                ""
              }
            />
            <input
            ...
            <div id="circulo-perfil-boton-div" className="">
              <button id="circulo-boton-perfil">
          ...
          <div id="photo-profile-box-perfil" className="col-4">
            <div id="circle-profile-card-img-perfil" className="m-4">
              {store.perfil && store.perfil.perfil.image_url != "" ? (
                <img
        ...
        {store.perfil &&
          store.perfil.talents.map((talento) => (
            <div id="section-photos-card-perfil" className="row">
              <div className="col-5" id="add-photos-container-card-perfil">
                <div id="section3-box-talent-card-perfil">
                  {talento.imagetalent_url.trim() != "" ? (
                    <img
                      id="img-photo-perfil-css"
                      src={talento.imagetalent_url}
                    />
                  ) : (
                    <img
                      id="img-photo-perfil-css"
              ...
              <div
                className="col"
                id="description-photos-container-card-perfil"
              >
                <input
                  id="inputtalento-1"
                  type="text"
                  value={talento.talent_name}
                  className="mb-2"
                />
                <input
                  id="inputtalento-2"
                  type="text"
                  value={talento.categories_talent}
                  className=""
                />
                <input
                  id="inputtalento-2"
                  type="text"
                  value={talento.practice_time}
                  className=""
                />
                <input
                  id="inputtalento-2"
                  type="text"
                  value={talento.range_talent}
                  className=""
                />
                <textarea
                  id="inputtalento-3"
                  type="text"
                  value={talento.about_you}
                  className=""
                />
              </div>
            </div>
