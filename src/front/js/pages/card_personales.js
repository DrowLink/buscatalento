          ...
          >
            ...
            <div id="buttons-final-card" className="col-md-6 text-center">
              <button
                ...
                className="btn btn"
              >
                Intercambiar<i className="fas fa-chalkboard-teacher"></i>
              </button>
              <Link to="/categories">
                <button
                  id="seguirviendo-button-card"
                  type="button"
                  className="btn btn"
                >
                  Seguir viendo <i className="fas fa-sync-alt"></i>
                </button>
              </Link>
            </div>
          </div>
